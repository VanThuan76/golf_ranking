...
const Error500 = () => {
  ...
  return (
    <>
      <Head>
        <title>{trans.common.notFound}</title>
      </Head>
      <section className='pt-45 lg:pt-50 xl:pt-55 pb-25 lg:pb-32.5 xl:pb-37.5 overflow-hidden'>
        <div className='animate_top mx-auto max-w-[518px] text-center'>
          <Image src={Img500} alt='404' className='mx-auto mb-7.5' width={396} height={156} />

          <h2 className='font-semibold text-2xl md:text-4xl text-black dark:text-white mb-5'>{trans.error.title500}</h2>
          <p className='mb-7.5'>{trans.error.description500}</p>
