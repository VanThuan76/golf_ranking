  ...
  return (
    <section className='pt-48 lg:pt-50 xl:pt-55 pb-25 lg:pb-32.5 xl:pb-37.5 overflow-hidden'>
      <div className='animate_top mx-auto max-w-[518px] text-center'>
        ...
        <h2 className='font-semibold text-2xl md:text-4xl text-black dark:text-white mb-5'>{trans.error.title404}</h2>
        <p className='mb-7.5'>{trans.error.description404}</p>
