...
export function TableDetailTournament() {
      ...
      cell(props) {
        return (
          <React.Fragment>
            ...
            {collapseStates[props.cell.row.id] && (
              <div
                className='relative w-[100px] h-[50px] flex items-center justify-center'
                onClick={() => router.push(`${URL_SYSTEMS.TOURNAMENT}/${props.cell.row.id}`)}
              >
